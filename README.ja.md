...
<p align="center">
    <b>wnrは" Work & Rest"の頭字語である。自由度が高い時間を控えるソフトウェアである</b>
</p>

<p align="center">
    | 時間を控えるソフトウェアとして、wnrは簡潔と高い実用性を持っている。<a href="https://getwnr.com/">公式Webサイト</a>
</p>

<p align="center">
    ｄん <i>(Windows & macOS)</i>: <a href="https://github.com/RoderickQiu/wnr/releases">GitHub Release</a> | <a
...
<p align="center">
    <a href="https://github.com/RoderickQiu/wnr/blob/master/README.md">English README</a> | <a href="https://github.com/RoderickQiu/wnr/blob/master/README.zh-CN.md">中国語（简体中文）</a> | <a href="https://github.com/RoderickQiu/wnr/blob/master/README.zh-TW.md">中国語（繁体字）</a>
</p>
...
使用 **[MPL 2.0 ](https://github.com/RoderickQiu/wnr/blob/master/LICENSE)** 进行许可。
...
#### 网站 / 文档 *([wnr-guide](https://github.com/RoderickQiu/wnr-guide)，使用 [[CC-BY-4.0](https://spdx.org/licenses/CC-BY-4.0.html)] ライセンス)*

- **vuepress，vuejs，MIT ライセンス**。
- vuepress-plugin-sitemap，ekoeryanto，MIT 许可证。
- vuepress-theme-api，sqrthree，MIT ライセンス。

### IDE

- **node，nodejs，**[**ライセンス**](https://github.com/nodejs/node/blob/master/LICENSE)。
- NSIS，Nullsoft，zlib/libpng ライセンス。
- WebStorm，JetBrains，[ライセンス](https://www.jetbrains.com/legal/#licensing)。
